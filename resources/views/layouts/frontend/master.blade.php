        ...
        <div class="row no-gutters">
            <div class="col-md-6 col-xs-12 col-lg-4">
                <div class="featured-slider mr-md-3 mr-lg-3">
                    <div class="item" style="background-image:url({{asset('asset/frontend/images/news/img-1.jpg')}})">
                        <div class="post-content">
            ...
            <div class="col-md-6 col-xs-12 col-lg-4">
                 <div class="featured-slider mr-lg-3">
                    <div class="item" style="background-image:url({{asset('asset/frontend/images/news/img-2.jpg')}})">
                        <div class="post-content">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-4">
                <div class="row mt-3 mt-lg-0">
                    <div class="col-lg-12 col-xs-12 col-sm-6 col-md-6">
                        <div class="post-featured-style" style="background-image:url({{asset('asset/frontend/images/news/news-02.jpg')}})">
                            <div class="post-content">
                    ...
                    <div class="col-lg-12 col-xs-12 col-sm-6 col-md-6">
                        <div class="post-featured-style" style="background-image:url({{asset('asset/frontend/images/news/news-04.jpg')}})">
                            <div class="post-content">
...
<section class="block-wrapper">
            ...
            <div class="post-block-wrapper clearfix mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{asset('asset/frontend/images/news/news-01.jpg')}}" alt="post-image"/>
                    </a>
                </div>
                <div class="post-content">
    ...
    <div class="post-overlay-wrapper">
        <div class="post-thumbnail">
            <img class="img-fluid" src="{{asset('asset/frontend/images/news/news-15.jpg')}}" alt="post-thumbnail"/>
        </div>
        <div class="post-content">
    ...
    <div class="post-list-block">
        ...
        <div class="post-block-wrapper post-float">
            <div class="post-thumbnail">
                <a href="single-post.html">
                    <img class="img-fluid" src="{{asset('asset/frontend/images/news/news-11.jpg')}}" alt="post-thumbnail"/>
                </a>
            </div>
    ...
    <div class="post-slide">
        <div class="item">
            <div class="post-overlay-wrapper clearfix">
                <div class="post-thumbnail">
                    <a href="single-post.html">
                        <img class="img-fluid" src="{{asset('asset/frontend/images/news/news-16.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
            ...
            <div class="post-overlay-wrapper clearfix mt-3">
                <div class="post-thumbnail">
                    <a href="single-post.html">
                        <img class="img-fluid" src="{{asset('asset/frontend/images/news/news-18.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
        ...
        <div class="item ">
            <div class="post-overlay-wrapper clearfix">
                <div class="post-thumbnail">
                    <a href="single-post.html">
                        <img class="img-fluid" src="{{asset('asset/frontend/images/news/news-17.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
            ...
            <div class="post-overlay-wrapper mt-3 clearfix">
                <div class="post-thumbnail">
                    <a href="single-post.html">
                        <img class="img-fluid" src="{{asset('asset/frontend/images/news/news-19.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="block">
                    ...
                    <div class="post-overlay-wrapper clearfix">
                        <div class="post-thumbnail">
                            <img class="img-fluid" src="{{asset('asset/frontend/images/news/news-13.jpg')}}" alt="post-thumbnail"/>
                        </div>
                    ...
                    <div class="post-list-block">
                        ...
                        <div class="post-block-wrapper post-float clearfix">
                            <div class="post-thumbnail">
                                <img class="img-fluid" src="{{asset('asset/frontend/images/news/news-12.jpg')}}" alt="post-thumbnail"/>
                            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="block">
                    ...
                    <div class="post-list-block">
                        ...
                        <div class="post-block-wrapper post-float clearfix">
                            <div class="post-thumbnail">
                                <img class="img-fluid" src="{{asset('asset/frontend/images/news/news-01.jpg')}}" alt="post-thumbnail"/>
                            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="block">
                    ...
                    <div class="post-list-block">
                        <div class="post-block-wrapper post-float clearfix">
                            <div class="post-thumbnail">
                                <img class="img-fluid" src="{{asset('asset/frontend/images/news/news-10.jpg')}}" alt="post-thumbnail"/>
                            </div>
                        ...
                        <div class="post-block-wrapper post-float clearfix">
                            <div class="post-thumbnail">
                                <img class="img-fluid" src="{{asset('asset/frontend/images/news/news-14.jpg')}}" alt="post-thumbnail"/>
                            </div>
    ...
    <div class="post-list-block">
        <div class=" review-post-list">
            <div class="top-author">
                <img src="{{asset('asset/frontend/images/news/author-01.jpg')}}" alt="author-thumb">
                <div class="info">
            ...
            <div class="top-author">
                <img src="{{asset('asset/frontend/images/news/author-02.jpg')}}" alt="author-thumb">
                <div class="info">
            ...
            <div class="top-author">
                <img src="{{asset('asset/frontend/images/news/author-03.jpg')}}" alt="author-thumb">
                <div class="info">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-sm-12 col-lg-6 text-center">
                <a href="index.html"><img src="{{asset('asset/frontend/images/logos/footer-logo.png')}}" alt="" class="img-fluid"></a>
