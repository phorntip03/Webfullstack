                      ...
                      <td>
                          <ul class="list-inline">
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="{{Asset('Asset/backend/dist/img/avatar.png')}}">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="{{Asset('Asset/backend/dist/img/avatar2.png')}}">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="{{Asset('Asset/backend/dist/img/avatar3.png')}}">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="{{Asset('Asset/backend/dist/img/avatar4.png')}}">
                              </li>
                          </ul>
                      </td>
